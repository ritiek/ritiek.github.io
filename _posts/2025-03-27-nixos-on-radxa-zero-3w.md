...
newer versions and the board I have come with the AIC WiFi chip. Both of these depened on a different
...
I also tried an RTL8192EU based WiFi dongle which has been a plug-and-play experience as well.


## How to know if the board is booting into the OS?

I've tried out the "Radxa CM3/CM3 I/O" variant from
[https://github.com/nabam/nixos-rockchip](https://github.com/nabam/nixos-rockchip)
...
However, I've also Radxa Zero 3E with me which doesn't seem to boot up with the Radxa CM3/CM3 I/O (or any
other) image. I'm not sure if I received a damaged board or that the boot addresses are different
